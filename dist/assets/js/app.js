// Translations moved to lang/*.json files and loaded via i18n.js
        ...
        function initBgColorPickerModal() {
            ...
            // 优化：复用已存在的实例，只更新颜色
            if (modalPickrs.bg) {
                modalPickrs.bg.setColor(canvas.backgroundColor || '#ffffff');
                return;
            }
        ...
        function initDrawColorPickerModal() {
            ...
            // 优化：复用已存在的实例，只更新颜色
            if (modalPickrs.draw) {
                modalPickrs.draw.setColor(savedBrushSettings.color);
                return;
            }
        ...
        function initTextColorPickerModal() {
            ...
            // 优化：复用已存在的实例，只更新颜色
            if (modalPickrs.text) {
                modalPickrs.text.setColor(savedTextSettings.fill);
                return;
            }
